...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation();
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.open-button').click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings('.card-reveal').toggleClass('open');
    }); // Close Card Reveal Click

    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.close-button').click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().parent('.card-reveal').toggleClass('open');
    });
...
module.exports = __webpack_require__(/*! c:\Users\heves\proba\src\assets\js\app.js */"./src/assets/js/app.js");
